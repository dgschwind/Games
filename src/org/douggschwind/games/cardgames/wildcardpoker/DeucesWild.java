...
public class DeucesWild extends WildCardGame {
	...
	public HandStrength determinePlayerHandStrength(Player player) {
		...
		Integer numberOfTwosInHand = numKindOccurrencesMap.get(Card.Kind.Two);
		if (numberOfTwosInHand == null) {
		...
		WildCardHand wildCardHand = WildCardHandFactory.create(numberOfTwosInHand.intValue(),
